    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      <div className="h-full lg:flex flex-col justify-center items-center px-4">
        <div className="text-center space-y-4 pt-16">
          <h1 className="font-bold text-3xl text-[#222]">Welcome Back!</h1>
          <p className="text-base text-gray-400">
            Log in or Create a Account to back your dashboard
          </p>
        </div>
        <div className="flex items-center justify-center mt-8">
          ...
          <ClerkLoading>
            <Loader2 className="animal-spin text-muted-foreground" />
          </ClerkLoading>
        </div>
      </div>
